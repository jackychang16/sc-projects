...
def add_data_for_name(name_data, year, rank, name):
    """
    Input
    name_data: Old data dictionary contained many names, each name including own dictionary contained year and rank.
     year: the year of the data entry to add
     rank: the rank of the data entry to add
     name: the name of the data entry to add

    Output
    This function modifies the name_data as stores provided year,rank and name.
