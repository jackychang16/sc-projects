...
This file helps babygraphics.py to organize every babyname's information
into the same data.
"""
...
def search_names(name_data, target):
    ...
    for name in name_data:
        compared_name = name.lower()
        if target.lower() in compared_name:
            list.append(name)
            # if compared_name not in list:
            #     list.append(name)
    return list
